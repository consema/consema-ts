/**
 * Frozen single-byte Windows code-page tables (source contract v2).
 *
 ...
 * (go/document/cp1252_table.go:1-9: every byte of the nine single-byte
 ...
 * pages through encoding_rs directly (crates/consema-document/src/source.rs:
 ...
 * (go/document/source.go:696-702).
 */

/** Malformed byte sentinel: encoding_rs 0.8.35 decodes this byte as Malformed (go/document/source.go:651-654). */
export const MALFORMED_BYTE_SENTINEL = 0xffff;

/** cp874 table (go/document/cp874_table.go:14-31). */
...
/** cp1250 table (go/document/cp1250_table.go:14-31). */
...
/** cp1251 table (go/document/cp1251_table.go:14-31). */
...
/** cp1252 table (go/document/cp1252_table.go:14-31). */
...
/** cp1253 table (go/document/cp1253_table.go:14-31). */
...
/** cp1254 table (go/document/cp1254_table.go:14-31). */
...
/** cp1255 table (go/document/cp1255_table.go:14-31). */
...
/** cp1256 table (go/document/cp1256_table.go:14-31). */
...
/** cp1257 table (go/document/cp1257_table.go:14-31). */
...
/** cp1258 table (go/document/cp1258_table.go:14-31). */
