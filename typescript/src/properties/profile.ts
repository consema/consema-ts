 ...
 *  - consema-rs/consema-properties/src/lib.rs (PropertiesProfile、profile ids)
...
/** Frozen Java Properties language profile (lib.rs). */
export type PropertiesProfile = 'ReaderV1' | 'Latin1V1';

/** `java-properties.reader@1` — explicitly decoded character source (lib.rs). */
export const PROFILE_READER_V1: PropertiesProfile = 'ReaderV1';
/** `java-properties.latin1@1` — ISO-8859-1 byte semantics (lib.rs). */
export const PROFILE_LATIN1_V1: PropertiesProfile = 'Latin1V1';

/** Immutable profile identifier (lib.rs; RFC 0010 §1). */
